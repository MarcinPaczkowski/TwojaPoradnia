const map = cmsClass => {
  return {
    ...
    section1: {
      ...
      description:
        cmsClass.elements.section1.value[0].elements.elements.value[0].elements
          .text.value,
      image:
        cmsClass.elements.section1.value[0].elements.elements.value[0].elements
          .image.value[0],
    ...
    section8: {
      ...
      content:
        cmsClass.elements.section8.value[0].elements.elements.value[0].elements
          .text.value,
      link: {
        text:
          cmsClass.elements.section8.value[0].elements.action.value[0].elements
            .buttontext.value,
        url:
          cmsClass.elements.section8.value[0].elements.action.value[0].elements
            .link.value,
